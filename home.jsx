...
function ServicesOverview() {
  const items = [
    ...
    },
    {
      n: "03",
      title: "The Return",
      copy: "A 6-week mind-body-spirit integration program — reflective psychotherapy, embodied regulation, spiritual grounding, and a personalized toolkit, co-created around you.",
      href: "the-return.html",
      meta: "Signature · 6 weeks · $175/session",
